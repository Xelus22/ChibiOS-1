...
/*
 * Setup for ENAC STM32 Elgo422-L422KB board.
 */

/*
 * Board identifier.
 */
#define BOARD_ELGO422_L422KB
#define BOARD_NAME                  "ENAC STM32 Elgo422-L422KB"
...
#define GPIOC_RCC_OSC32_IN          14U
#define GPIOC_LED_HEARTBEAT         15U
...
#define LINE_VCP_TX                 PAL_LINE(GPIOB, 6U)
#define LINE_VCP_RX                 PAL_LINE(GPIOB, 7U)
#define LINE_RCC_OSC32_IN           PAL_LINE(GPIOC, 14U)
#define LINE_LED_HEARTBEAT          PAL_LINE(GPIOC, 15U)
 ...
 * PA15 - PIN15                     (analog).
 */
#define VAL_GPIOA_MODER             (PIN_MODE_ALTERNATE(GPIOA_RCC_CK_IN) |  \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_RCC_CK_IN) |  \
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_HIGH(GPIOA_RCC_CK_IN) |     \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_RCC_CK_IN) |  \
...
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(GPIOA_RCC_CK_IN) |        \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_RCC_CK_IN, 0U) |     \
...
#define VAL_GPIOA_ASCR              (PIN_ASCR_DISABLED(GPIOA_RCC_CK_IN) |   \
...
#define VAL_GPIOA_LOCKR             (PIN_LOCKR_DISABLED(GPIOA_RCC_CK_IN) |  \
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_HIGH(GPIOB_PIN0) |          \
                                     ...
                                     PIN_OSPEED_MEDIUM(GPIOB_VCP_TX) |      \
                                     PIN_OSPEED_MEDIUM(GPIOB_VCP_RX) |      \
...
#define VAL_GPIOB_ASCR              (PIN_ASCR_DISABLED(GPIOB_PIN0) |        \
                                     ...
                                     PIN_ASCR_DISABLED(GPIOB_VCP_TX) |      \
                                     PIN_ASCR_DISABLED(GPIOB_VCP_RX) |      \
...
#define VAL_GPIOB_LOCKR             (PIN_LOCKR_DISABLED(GPIOB_PIN0) |       \
                                     ...
                                     PIN_LOCKR_DISABLED(GPIOB_VCP_TX) |     \
                                     PIN_LOCKR_DISABLED(GPIOB_VCP_RX) |     \
 ...
 * PC12 - PIN12                     (analog).
 * PC13 - PIN13                     (analog).
 * PC14 - RCC_OSC32_IN              (alternate 0).
 * PC15 - LED_HEARTBEAT             (output pushpull maximum).
 */
#define VAL_GPIOC_MODER             (PIN_MODE_ANALOG(GPIOC_PIN0) |          \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOC_RCC_OSC32_IN) |\
                                     PIN_MODE_OUTPUT(GPIOC_LED_HEARTBEAT))
#define VAL_GPIOC_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOC_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOC_RCC_OSC32_IN) |\
                                     PIN_OTYPE_PUSHPULL(GPIOC_LED_HEARTBEAT))
#define VAL_GPIOC_OSPEEDR           (PIN_OSPEED_HIGH(GPIOC_PIN0) |          \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOC_RCC_OSC32_IN) |  \
                                     PIN_OSPEED_HIGH(GPIOC_LED_HEARTBEAT))
#define VAL_GPIOC_PUPDR             (PIN_PUPDR_FLOATING(GPIOC_PIN0) |       \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOC_RCC_OSC32_IN) |\
                                     PIN_PUPDR_FLOATING(GPIOC_LED_HEARTBEAT))
#define VAL_GPIOC_ODR               (PIN_ODR_HIGH(GPIOC_PIN0) |             \
                                     ...
                                     PIN_ODR_HIGH(GPIOC_RCC_OSC32_IN) |     \
                                     PIN_ODR_LOW(GPIOC_LED_HEARTBEAT))
...
#define VAL_GPIOC_AFRH              (PIN_AFIO_AF(GPIOC_PIN8, 0U) |          \
                                     ...
                                     PIN_AFIO_AF(GPIOC_RCC_OSC32_IN, 0U) |  \
                                     PIN_AFIO_AF(GPIOC_LED_HEARTBEAT, 0U))
#define VAL_GPIOC_ASCR              (PIN_ASCR_DISABLED(GPIOC_PIN0) |        \
                                     ...
                                     PIN_ASCR_DISABLED(GPIOC_RCC_OSC32_IN) |\
                                     PIN_ASCR_DISABLED(GPIOC_LED_HEARTBEAT))
#define VAL_GPIOC_LOCKR             (PIN_LOCKR_DISABLED(GPIOC_PIN0) |       \
                                     ...
                                     PIN_LOCKR_DISABLED(GPIOC_RCC_OSC32_IN) |\
                                     PIN_LOCKR_DISABLED(GPIOC_LED_HEARTBEAT))
